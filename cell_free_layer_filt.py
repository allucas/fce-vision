...
#%% Initial Parameters
location = '/Users/AlfredoLucas/Documents/Trabajos/University/Cabrales/PIV/flow_4' # Image stack location
os.chdir(location)
filename = 'flow' # Image names
n_frames = 800 # Number of frames to load and average over the PIV results
y_length = [400,750] # Y limits of the image
